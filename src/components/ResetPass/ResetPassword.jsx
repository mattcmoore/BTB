...
const ResetPassword = () => {
  ...
  const handleResetPassword = async () => {
    try {
      // Replace this with the actual API URL to send the reset password link
  ...
  return (
    <div className="containerReset">
      ...
      <button className='resetBtn' onClick={handleResetPassword}>Send Reset Password Link</button>
      </div>
      {message && <p>{message}</p>}
      </div>
    </div>
