  ...
  return (
    ...
    >
      <div className="admin-navbar-buttons">
        ...
        <div>
          <span className="classes-btn">Classes</span>
        </div>
        <div>
          <span className="admins-btn">Admins</span>
        </div>
        <div>
          <span className="archives-btn">Archives</span>
        </div>
      </div>
      <div className={`admin-dropdown ${mouseover ? "mouseover" : ""}`}>
        ...
        >
          ...
          <svg className="triangle" viewBox="0 0 232.72 86.82">
            <path
              className="cls-1"
              d="M116.02,120.76L1.17,.5H230.88L116.02,120.76Z"
            />
          </svg>
        </div>
        ...
        <div className={mouseover ? "admin-dropdown-sign-out" : "hidden"}>
          SIGN OUT
        </div>
      </div>
    </div>
