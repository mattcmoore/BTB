import './AdminStudentInterface.css'
import BtbContext from '../../../context/BtbContext'
import BTBlogo from '../../../assets/blue-ocean-logo-2.png';
import { useContext, useState, useEffect } from 'react'

const AdminStudentInterface = () => {
    // const {fetchNotes, fetchTasks} = useContext(BtbContext)
    ...
    const { notes, addNewNote, openNoteModal, closeNoteModal, fetchNotes, user, tasks, fetchTasks, closeStudentModal, individualUser, fetchIndividualUser, } = useContext(BtbContext)
    ...
    useEffect(() => {
        fetchIndividualUser()
        if (user.admin === false){
            fetchTasks(individualUser.id)
            fetchNotes(individualUser.id)
        }
        console.log(tasks)
    },[])
                    ...
                    <div className="student-container" >
                        <div className="outprocessing-container">
                            ...
                            <div className="student-section" >
                                ...
                                >
                                    {individualUser.name}
                                    {/* {console.log(individualUser.name)} */}
                                </h3>
                                <h3 
                                    id="branch"
                                    className="student-info"
...
export default AdminStudentInterface