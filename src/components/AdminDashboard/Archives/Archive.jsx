                ...
                <div className={selected === i ? 'content show' : 'content'}>
                  <div className='item_wrapper'>
                    {userNames.map((user, j) => (
                      <div className='item_card' key={j} onClick={openStudentModal} name={user.id}>
